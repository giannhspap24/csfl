...
# Plotting the lines
plt.plot(time_csfl, acc_csfl, linestyle='--', color='c', label='HSFL-ll', linewidth=3)
plt.plot(time_sfl_tirana, acc_sfl_tirana, linestyle='-', color='g', label='SFL-helpers', linewidth=3)
plt.plot(time_sfl, acc_sfl, linestyle='-', color='b', label='SFL', linewidth=3)
plt.plot(time_accsfl, acc_accsfl, linestyle='-', color='m', label='ACCSFL(CONV-5)', linewidth=3)

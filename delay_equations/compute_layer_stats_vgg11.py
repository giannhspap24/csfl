...
def compute_flops_per_layer(model, input_shape=(1, 3, 32, 32)):
    ...
    def make_hook(name, layer_type):
        def hook(layer, inp, out):
            ...
            param_mem_bytes = param_count * 4  # float32 = 4 bytes
    ...
    print(f"{'Layer':<30} {'FWD (MFLOPs)':>15} {'BWD (MFLOPs)':>15} {'Total (MFLOPs)':>18} {'Param Mem (MB)':>17}")
    print("=" * 110)
    total_fwd, total_bwd, total_all, total_mem = 0, 0, 0, 0
    for name, stats in layer_flops.items():
        ...
        total_all += total
        total_mem += mem
        print(f"{name:<30} {fwd:>15.2f} {bwd:>15.2f} {total:>18.2f} {mem:>17.2f}")
    print("=" * 110)
    print(f"{'Total':<30} {total_fwd:>15.2f} {total_bwd:>15.2f} {total_all:>18.2f} {total_mem:>17.2f}")

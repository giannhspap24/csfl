...
df1 = pd.read_excel("full_model_accuracy_cut_layer_5.xlsx")
df2=pd.read_excel("full_model_accuracy_cut_layer_4.xlsx")
df3 = pd.read_excel("full_model_accuracy_cut_layer_3.xlsx")
...
plt.plot(time_csfl, full_accuracies_smoothed1, linestyle='-', marker='*', color='r', label='SFL(Conv 5)', linewidth=4, markersize=1)
plt.plot(time_csfl, full_accuracies_smoothed2, linestyle='-.', marker='o', color='g', label='SFL(Conv 4)', linewidth=4, markersize=1)
plt.plot(time_sfl, full_accuracies_smoothed3, linestyle='--', marker='s', color='b', label='SFL(Conv 3)', linewidth=4, markersize=1)

...
time_per_epoch_csfl = 1
time_per_epoch_sfl_tirana = 1
time_per_epoch_sfl = 1
time_per_epoch_accsfl = 1
...
plt.xticks(range(0, 201, 40),fontsize=14, fontweight='bold')
...
# Save and show
plt.savefig("A2_new.pdf", format="pdf", bbox_inches="tight")
plt.show()

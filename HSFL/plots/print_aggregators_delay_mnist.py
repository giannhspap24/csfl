...
time_per_epoch_csfl = 8
time_per_epoch_sfl_tirana = 7.5
time_per_epoch_sfl = 7.5
time_per_epoch_accsfl = 8.2
...
plt.xticks(range(0, 1501, 300),fontsize=14, fontweight='bold')
...
# Save and show
plt.savefig("aggregators_delay_mnist.pdf", format="pdf", bbox_inches="tight")
plt.show()

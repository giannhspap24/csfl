...
time_per_epoch_csfl = 76.3 +30 #lamba=0.25
time_per_epoch_sfl_tirana = 76.3 +5 #lamba=0.8
time_per_epoch_sfl = 76.3 + 20#lamba=0.5
time_per_epoch_accsfl = 76.3 +40 #lamba=0.1
...
# Plotting the lines
plt.plot(time_accsfl, acc_accsfl, linestyle='-', color='m', label='SFL3 (λ=0.10)',  linewidth=4, markersize=1)
plt.plot(time_csfl, acc_csfl, linestyle='--', color='c', label='SFL3 (λ=0.25)', linewidth=4,markersize=1)
plt.plot(time_sfl_tirana, acc_sfl_tirana, linestyle='dashdot', color='g', label='SFL3 (λ=0.50)', linewidth=4,markersize=1)
plt.plot(time_sfl, acc_sfl, linestyle='dotted', color='b', label='SFL3 (λ=0.80)', linewidth=4,markersize=1)

# Labels
plt.xlabel('Training Time (seconds)', fontsize=18, fontweight='bold')
plt.ylabel('Test Accuracy', fontsize=18, fontweight='bold')

# Set custom Y-ticks
plt.yticks(range(0, 101, 10), fontsize=14, fontweight='bold')
plt.xticks(range(0, 7501, 1500),fontsize=14, fontweight='bold')
...
# Save and show
plt.savefig("aggregators_delay_vgg11.pdf", format="pdf", bbox_inches="tight")
plt.show()

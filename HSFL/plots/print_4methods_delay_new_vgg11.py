...
time_per_epoch_csfl = 76.3
time_per_epoch_sfl_tirana = 120+50
time_per_epoch_sfl = 140+50
time_per_epoch_accsfl = 110+40
...
# Save and show
plt.savefig("accuracy_vs_delay_vgg11.pdf", format="pdf", bbox_inches="tight")
plt.show()

...
fed_avg_freq=5 
cut_layer="conv5"
program = "sfl_100_clients_fed_avg_freq_"+str(fed_avg_freq)+"_cut_layer_"+cut_layer
...
# CONV 5 SPLIT LAYERS
selected_layers = ["15.weight", "15.bias", "18.weight", "18.bias","21.weight", "21.bias"]
#==============================================================================================================
#                                  Client Side Program 
#==============================================================================================================
...
w_glob_client1 = copy.deepcopy(w_glob)
...
for iter in range(epochs):
    ...
    for idx in idxs_users: # each client
        ...
        #new code here:
        w_locals_client1.append(copy.deepcopy(w))
    ...
    if (iter + 1) % fed_avg_freq == 0:
        ...
        for idx in idxs_users:
            ...
            if idx in idxs_users:
                net_glob.load_state_dict(w_glob_client1)
